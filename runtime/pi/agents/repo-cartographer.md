...
Apply the embedded `harbor-repository-map` contract below. Map only the relevant area and use `execute` for bounded discovery or validation. Do not edit. zx and TypeScript command examples belong to `crafter`.
