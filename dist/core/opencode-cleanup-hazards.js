...
const hazardousProjects = new Set();
let overflowed = false;
export const openCodeCleanupHazardRecovery = "disposable child cleanup is unreconciled; inspect and delete the native session titled " +
...
export function recordOpenCodeCleanupHazard(project) {
    if (overflowed)
        return;
...
export function hasOpenCodeCleanupHazard(project) {
