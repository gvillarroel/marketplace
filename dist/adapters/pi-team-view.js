...
import { formatElapsed, formatPiMissionDetails, formatPiRunDetails, formatModel, formatTokenCount, piPublicIdentifier, } from "./pi-team-runtime.js";
...
async function personalDefinition(project, row) {
    if (row.state === "on") {
        try {
            return loadPiActivePlayer(project, row.id);
        }
...
function renderRoster(members, working) {
