...
const defaults = [
  ...
  "test-ts/active-startup.test.ts",
  "test-ts/public-metadata.test.ts",
  "test-ts/pi-team.test.ts",
  "test-ts/copilot-team.test.ts",
  "test-ts/shared-runtime-activity.test.ts",
  ...
  "test-ts/opencode-team.test.ts",
  "test-ts/opencode-agent-activity.test.ts",
  "test-ts/opencode-server-hardening.test.ts",
